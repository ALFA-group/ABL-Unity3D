...
v2fline line4vertPixelBillboard (appdataL v) {
    v2fline o;
	// stereo & instancing
	...
	fixed uvsign = 2;
	float w =  lerp(  _WidthMultiplier * v.uv.y*0.5,  _ScreenParams.y * _WidthMultiplier* v.uv.y * 0.005,  _PersentOfScreenHeightMode);
